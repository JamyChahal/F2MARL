...
from training.custom_models.centralizedCriticModel import YetAnotherCentralizedCriticModel
...
def main(args):
    ...
    ModelCatalog.register_custom_model("cc_model", YetAnotherCentralizedCriticModel)
